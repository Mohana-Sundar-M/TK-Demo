...
export const TheaterCard: React.FC<TheaterCardProps> = ({ theater }) => {
  ...
  return (
    <div
      className="flex border rounded-xl shadow-md mb-6 mx-auto p-4"
    ...
    >
      ...
      <div className="w-2/5 ml-4 flex flex-col justify-between">
          ...
          <div className="relative">
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M5.47 9.53a.75.75 0 011.06 0l4 4a.75.75 0 11-1.06 1.06l-4-4a.75.75 0 010-1.06z"
                  clipRule="evenodd"
                />
              </svg>
            </button>
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M10 14a.75.75 0 01-.53-1.28l3.47-3.47-3.47-3.47a.75.75 0 111.06-1.06l4 4a.75.75 0 010 1.06l-4 4a.75.75 0 01-.53.22z"
                  clipRule="evenodd"
                />
              </svg>
            </button>
        ...
        <div
          className="flex overflow-x-auto space-x-2 pb-1"
          ref={scrollRef}
          style={{ height: "100px" }}
        >
